  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='p-4 max-w-lg mx-auto items-center' >
      <div className='mb-4'>
        ...
        id='name'
        {...register('name')}
        className={`bg-sky-800 text-white mt-1 block w-full px-3 py-2 border ${errors.name? 'border-red-500':'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`} />
      ...
      <div className="mb-4">
        ...
        <input
          ...
          type="date"
          {...register('dob')}
          className={`bg-sky-800 text-white mt-1 block w-full px-3 py-2 border ${errors.dob ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
        />
      ...
      <div className="mb-4">
        ...
        <input
          ...
          type="email"
          {...register('email')}
          className={`bg-sky-800 text-white mt-1 block w-full px-3 py-2 border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
        />
      ...
      <div className="mb-4">
        ...
        <input
          ...
          type="tele"
          {...register('mobile')}
          className={`bg-sky-800 text-white mt-1 block w-full px-3 py-2 border ${errors.mobile ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
        />
      ...
      <div className='mb-4 '>
        ...
        {...register('address')}
        className={`text-white bg-sky-800 mt-1 block w-full px-3 py-2 border ${errors.name? 'border-red-500':'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`} />
