...
const Home = () => {
  return (
    ...
    <div className=' px-4 md:w-1/2 mb-5 md:mb-0'>
        <img className='rounded-2xl w-full'src={home} alt="Home" />
      </div>
      <div className='px-4 md:w-1/2 border-white rounded-2xl border-2' >
